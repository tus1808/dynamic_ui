...
4. Report the result. If there are dependency errors (missing libgtk-3-dev, libjson-glib-dev, etc.), remind the user that those must be installed on the **target Orange Pi device**, not the Windows dev machine.
